	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord10_g66 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord12_g66 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord2_g66 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;1252;-848,-192;Inherit;False;Global;CZY_CloudsFogAmount;CZY_CloudsFogAmount;8;0;Create;True;0;0;0;False;0;False;0;0.82;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1253;-848,-272;Inherit;False;Global;CZY_CloudsFogLightAmount;CZY_CloudsFogLightAmount;7;0;Create;True;0;0;0;False;0;False;0;0.443;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2BB58D74E29895CAD06F3B5C80AD8FC4513D285E